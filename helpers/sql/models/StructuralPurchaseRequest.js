...
class StructuralPurchaseRequest extends Model {}

module.exports = (sequelize) => {
  StructuralPurchaseRequest.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: "StructuralPurchaseRequest",
      tableName: "structural_purchase_requests",
    }
  );

  return StructuralPurchaseRequest;
};
